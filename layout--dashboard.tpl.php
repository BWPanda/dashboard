...
/**
 * @file
 * Template for the Dashboard layout.
 *
 * Variables:
...
<div class="layout--dashboard <?php print implode(' ', $classes); ?>"<?php print backdrop_attributes($attributes); ?>>
  <div id="skip-link">
  ...
  <div class="l-container">
    ...
    <?php if ($content['sidebar']): ?>
      <div class="l-sidebar"><?php print $content['sidebar']; ?></div>
    <?php endif; ?>
  </div>
